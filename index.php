...
<body>
       ...
       <img src="Entet App Logo Link" alt="Icon">
        ...
        <h2 class="active">FastWin</h2><br><br>
...
$url1='https://fastwin.app/nrxl/token';

$data1='token=1&mob='.$mo.'&pin=Ad98itya@&ref='.$refer.' ';

$headers1[]='Host: fastwin.app';
$headers1[]='accept: */*';
$headers1[]='content-type: application/x-www-form-urlencoded; charset=UTF-8';
$headers1[]='origin: https://fastwin.app';
$headers1[]='referer: https://fastwin.app/LR?RG&C='.$refer.' ';
